...
build/X86/gem5.opt configs/example/se.py -c ../programs/eg_pthread -o 3 --ruby --topology Crossbar -n 4 --l1i_size=32kB --l1d_size=32kB --l2_size=512MB --num-l2caches=1
